...
//
namespace PdfTools\fpdi;

class FPDF_TPL extends \PdfTools\FPDF\FPDF {
    /**
     * Array of Tpl-Data
     * @var array
     */
    ...
    protected $_useGlobalTemplate = false;
    protected $_globalTemplateParams = array();
     ...
     * @param type $_h
     */
    public function useGlobalTemplate($tplidx, $_x = null, $_y = null, $_w = 0, $_h = 0)
    {
        $this->_useGlobalTemplate = true;
        $this->_globalTemplateParams = func_get_args();
    }
    
    public function stopGlobalTemplate()
    {
        $this->_useGlobalTemplate = false;
    }
    ...
    function AddPage($orientation = '', $format = '', $keepmargins = false, $tocpage = false) {
        ...
        // var_dump('la');
        if ($this->_useGlobalTemplate) {
            call_user_func_array(array($this, 'useTemplate'), $this->_globalTemplateParams);
        }
    }
