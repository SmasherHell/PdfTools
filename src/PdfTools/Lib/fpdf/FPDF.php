...
namespace PdfTools\FPDF;
// error_reporting(E_ALL & ~E_STRICT);

define('FPDF_VERSION','1.7');

// class FPDF extends \PdfTools\fpdi\FPDFBridge
class FPDF
{
...
// parent::__construct($orientation, $unit, $size);
    ...
    {   
            ...
            if($layout=='single' || $layout=='continuous' || $layout=='two' || $layout=='default' || $layout == 'SinglePage')
                    $this->LayoutMode = $layout;
            else
                    $this->Error('Incorrect layout display mode: '.$layout);
       
        //parent::SetDisplayMode($zoom, $layout, $mode);
    }

    function SetCompression($compress = true)
    {
    ...
    public function SetTextColorArray(array $color)
    {
        $r = $color[0] ? : 0;
        $g = $color[0] ? : null;
        $b = $color[0] ? : null;
